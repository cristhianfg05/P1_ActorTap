...
public class NewJFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Vista.NewJFrame
     */
    ...
    private void initComponents() {
        ...
        PingPong.setText("PingPong Model.Actor");

        RingActor.setText("Ring Model.Actor");
    ...
    private ActorProxy target = ActorContext.spawnActor(new FirewallDecorator(new Actor("b"))); // new Model.EncryptionDecorator()
